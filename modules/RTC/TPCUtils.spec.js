    ...
    describe("Test encodings when default settings are used for", () => {
        ...
        describe("AV1 camera tracks", () => {
            ...
            it("and requested resolution is 720", () => {
                height = 720;
                activeState = tpcUtils.calculateEncodingsActiveState(
                    track,
                    codec,
                    height,
                );
                ...
                maxBitrates = tpcUtils.calculateEncodingsBitrates(
                    track,
                    codec,
                    height,
                );
                ...
                scalabilityModes = tpcUtils.calculateEncodingsScalabilityMode(
                    track,
                    codec,
                    height,
                );
                expect(scalabilityModes[0]).toBe(
                    VideoEncoderScalabilityMode.L3T3_KEY,
                );
                expect(scalabilityModes[1]).toBe(undefined);
                expect(scalabilityModes[2]).toBe(undefined);

                scaleFactor = tpcUtils.calculateEncodingsScaleFactor(
                    track,
                    codec,
                    height,
                );
        ...
        describe("H.264 camera tracks", () => {
            ...
            it("and requested resolution is 720", () => {
                ...
                expect(scalabilityModes[1]).toBe(
                    VideoEncoderScalabilityMode.L1T3,
                );
                expect(scalabilityModes[2]).toBe(
                    VideoEncoderScalabilityMode.L1T3,
                );
        ...
        describe("VP8 camera tracks", () => {
            ...
            it("and capture resolution is 4k", () => {
                height = 180;
                const highResolutiontrack = new MockJitsiLocalTrack(
                    2160,
                    "video",
                    "camera",
                );
    ...
    describe("Test encodings when settings are overwritten", () => {
        ...
        describe("for AV1 camera tracks when simulcast is configured", () => {
            ...
            it("and requested resolution is 720", () => {
                ...
                bitrates = tpcUtils.calculateEncodingsBitrates(
                    track,
                    codec,
                    height,
                );
        ...
        describe("for VP9 camera/desktop tracks when simulcast is used", () => {
            ...
            it("and requested desktop resolution is 2160", () => {
                ...
                activeState = utils.calculateEncodingsActiveState(
                    desktop,
                    codec,
                    height,
                );
                ...
                bitrates = utils.calculateEncodingsBitrates(
                    desktop,
                    codec,
                    height,
                );
                ...
                scalabilityModes = utils.calculateEncodingsScalabilityMode(
                    desktop,
                    codec,
                    height,
                );
                ...
                scaleFactor = utils.calculateEncodingsScaleFactor(
                    desktop,
                    codec,
                    height,
                );
