...
class MLineWrap {
     ...
     * objects.
     */
    get ssrcs(): Array<{ id: number; attribute: string; value: string }> {
        if (!this.mLine.ssrcs) {
            this.mLine.ssrcs = [];
        }
     ...
     * objects.
     */
    set ssrcs(ssrcs: Array<{ id: number; attribute: string; value: string }>) {
     ...
     */
    addSSRCAttribute(ssrcObj: { id: number; attribute: string; value: string }): void {
