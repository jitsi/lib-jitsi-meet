...
describe("SDP", () => {
    ...
    describe("toJingle", () => {
        ...
        it("correctly groups ssrcs lines that are not in order", () => {
            ...
            const videoSources = nodeTree.querySelectorAll(
        ...
        it("put source names as source element attributes", () => {
            ...
            const audioSources = nodeTree.querySelectorAll(
    ...
    describe("toJingle for multiple m-lines", () => {
        ...
        it("correctly groups ssrcs lines", () => {
            ...
            const videoSourceGroups = nodeTree.querySelectorAll(
                "description[media='video']>ssrc-group",
            );

            expect(videoSourceGroups.length).toBe(4);
            const data = nodeTree.querySelectorAll(
                "jingle>content[name='data']",
            );
    ...
    describe("jingle2media", () => {
        it("should convert basic Jingle content to SDP", () => {
            ...
            expect(media).toContain(
                "a=candidate:1 1 udp 2130706431 192.168.1.1 10000 typ host",
            );
        });
        ...
        it("should convert Jingle content with ICE candidates to SDP", () => {
            ...
            expect(media).toContain(
                "a=candidate:2 1 tcp 2130706430 192.168.1.2 10001 typ host",
            );
        });
    });
});
