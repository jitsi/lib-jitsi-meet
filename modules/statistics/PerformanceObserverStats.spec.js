...
describe("PerformanceObserverStats", () => {
    ...
    it("Conference events start/stop observer", () => {
        ...
        const startObserverSpy = spyOn(
            statistics.performanceObserverStats,
            "startObserver",
        );
        const stopObserverSpy = spyOn(
            statistics.performanceObserverStats,
            "stopObserver",
        );
    ...
    it("Emits long tasks stats every sec", () => {
        ...
        const eventEmitSpy = spyOn(
            statistics.performanceObserverStats.eventEmitter,
            "emit",
        );

        expect(
            statistics.performanceObserverStats.getLongTasksStats(),
        ).toBeTruthy();
