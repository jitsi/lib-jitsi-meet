        ...
        return new Promise((resolve, reject) => {
            ...
            (this.connection as Connection).sendIQ(
                ...
                result => {
                    ...
                    const refElement = findAll(result, 'ref')[0];
                    const resource = refElement ? getAttribute(refElement, 'uri') : null;

                    this.callResource = (resource as string).substr('xmpp:'.length);
