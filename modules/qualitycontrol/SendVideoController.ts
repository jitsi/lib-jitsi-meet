...
export default class SendVideoController {
     ...
     * @returns {Promise<void[]>}
     */
    onSenderConstraintsReceived(videoConstraints: IVideoConstraint): void {
     ...
     */
    setPreferredSendMaxFrameHeight(maxFrameHeight: number): Promise<PromiseSettledResult<void>[]> {
