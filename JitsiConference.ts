...
export default class JitsiConference {
    ...
    _audioSenderLimitReached?: boolean;
    _videoSenderLimitReached?: boolean;
    _firefoxP2pEnabled: boolean;
    _iceRestarts: number;
    room?: ChatRoom;
...
.toLowerCase();
    ...
    _init(options: ConferenceOptions): void {
        ...
        this.setLocalParticipantProperty('codecList',
             this.qualityController.codecController.getCodecPreferenceList('jvb').join(','));
   ...
   */
    on(eventId: string, handler: (...args: any[]) => void): void {
   ...
   * @param {Function} handler - Handler for the event.
   */
    once(eventId: string, handler: (...args: any[]) => void): void {
        if (this.eventEmitter) {
   ...
   */
    off(eventId: string, handler?: (...args: any[]) => void): void {
        if (this.eventEmitter) {
   ...
   * @param {Function} handler - Handler for the event.
   */
    addEventListener(eventId: string, handler: (...args: any[]) => void): void {
   ...
   * @param {Function} [handler] - Optional, the specific handler to unbind.
   */
    removeEventListener(eventId: string, handler?: (...args: any[]) => void): void {
   ...
   */
    addCommandListener(command: string, handler: (...args: any[]) => void): void {
        if (this.room) {
   ...
   */
    removeCommandListener(command: string, handler: (...args: any[]) => void): void {
        if (this.room) {
   ...
   */
     ...
     */
    onCallAccepted(session: JingleSessionPC, answer: any): void {
     ...
     */
    onTransportInfo(session: JingleSessionPC, transportInfo: any): void {
        if (this.p2pJingleSession === session) {
     ...
     * @private
     */
    _onIncomingCallP2P(jingleSession: JingleSessionPC, jingleOffer: any): void {
        let rejectReason;
     ...
     */
    onIncomingCall(jingleSession: JingleSessionPC, jingleOffer: any, now: number): void {
     ...
     * @private
     */
    _acceptJvbIncomingCall(jingleSession: JingleSessionPC, jingleOffer: any, now: number): void {
     ...
     * @private
     */
    _acceptP2PIncomingCall(jingleSession: JingleSessionPC, jingleOffer: any): void {
        this.isP2PConnectionInterrupted = false;
     ...
     * @private
     */
    _updateProperties(properties: any = {}): void {
     ...
     */
    _stopJvbSession(options: any = {}): void {
        const {
     ...
     * @private
     */
    _stopP2PSession(options: any = {}): void {
        const {
            reason = 'success',
     ...
     */
    _updateRoomPresence(jingleSession: JingleSessionPC, ctx: any): void {
        if (!jingleSession) {
            return;
        }
     ...
     * @returns {void}
     */
    removeLobbyMessageHandler(handler: (message: any) => void): void {
        if (this.room) {
     ...
     */
    getShortTermCredentials(service: string): Promise<any> {
        if (this.room) {
