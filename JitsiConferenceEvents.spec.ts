...
describe( "/JitsiConferenceEvents members", () => {
    ...
    it( "known members", () => {
        ...
        expect( JitsiConferenceEvents.E2EE_SAS_READY ).toBe( 'conference.e2ee.sas.ready' );
        expect( JitsiConferenceEvents.E2EE_SAS_COMPLETED ).toBe( 'conference.e2ee.sas.completed' );
    } );
