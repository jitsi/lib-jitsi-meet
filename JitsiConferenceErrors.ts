...
export const CONFERENCE_ACCESS_DENIED =
...
export const PASSWORD_NOT_SUPPORTED =
    JitsiConferenceErrors.PASSWORD_NOT_SUPPORTED;
...
export const VIDEOBRIDGE_NOT_AVAILABLE =
