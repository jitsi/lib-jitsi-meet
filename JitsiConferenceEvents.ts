...
export const _MEDIA_SESSION_STARTED =
    JitsiConferenceEvents._MEDIA_SESSION_STARTED;
export const _MEDIA_SESSION_ACTIVE_CHANGED =
    JitsiConferenceEvents._MEDIA_SESSION_ACTIVE_CHANGED;
export const AUDIO_INPUT_STATE_CHANGE =
    JitsiConferenceEvents.AUDIO_INPUT_STATE_CHANGE;
export const AUDIO_UNMUTE_PERMISSIONS_CHANGED =
...
export const BREAKOUT_ROOMS_MOVE_TO_ROOM =
    JitsiConferenceEvents.BREAKOUT_ROOMS_MOVE_TO_ROOM;
export const BREAKOUT_ROOMS_UPDATED =
    JitsiConferenceEvents.BREAKOUT_ROOMS_UPDATED;
export const CONFERENCE_CREATED_TIMESTAMP =
...
export const CONFERENCE_JOIN_IN_PROGRESS =
...
export const CONFERENCE_UNIQUE_ID_SET =
    JitsiConferenceEvents.CONFERENCE_UNIQUE_ID_SET;
export const CONFERENCE_VISITOR_CODECS_CHANGED =
...
export const NON_PARTICIPANT_MESSAGE_RECEIVED =
...
export const PARTICIPANT_SOURCE_UPDATED =
    JitsiConferenceEvents.PARTICIPANT_SOURCE_UPDATED;
export const PRIVATE_MESSAGE_RECEIVED =
...
export const RECORDER_STATE_CHANGED =
    JitsiConferenceEvents.RECORDER_STATE_CHANGED;
export const SERVER_REGION_CHANGED =
    JitsiConferenceEvents.SERVER_REGION_CHANGED;
export const SILENT_STATUS_CHANGED =
...
export const TRACK_UNMUTE_REJECTED =
...
export const VIDEO_UNMUTE_PERMISSIONS_CHANGED =
    JitsiConferenceEvents.VIDEO_UNMUTE_PERMISSIONS_CHANGED;
export const VISITORS_SUPPORTED_CHANGED =
