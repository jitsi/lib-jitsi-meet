    ...
    */
    ...
    async joinConference(
        ...
        if (appId.startsWith('vpaas-magic-cookie')) {
            ...
            const autoInit = Symbol.for('kLJMAutoInit');

            if (typeof window[autoInit] === 'undefined') {
                window[autoInit] = true;

                // TODO(saghul): review rtcstats initialization.
                this.init({
                    analytics: {
        ...
        function onConnectionEstablished() {
            ...
            queueMicrotask(() => {
                ...
                // TODO(saghul): set some sender / receiver constraints?
            });
        }
