...
describe("/JitsiTrackEvents members", () => {
    ...
    it("known members", () => {
        ...
        expect(TRACK_STREAMING_STATUS_CHANGED).toBe(
            "track.streaming_status_changed",
        );
        ...
        expect(JitsiTrackEvents.TRACK_AUDIO_LEVEL_CHANGED).toBe(
            "track.audioLevelsChanged",
        );
        expect(JitsiTrackEvents.TRACK_AUDIO_OUTPUT_CHANGED).toBe(
            "track.audioOutputChanged",
        );
        expect(JitsiTrackEvents.TRACK_MUTE_CHANGED).toBe(
            "track.trackMuteChanged",
        );
        expect(JitsiTrackEvents.TRACK_OWNER_SET).toBe("track.owner_set");
        expect(JitsiTrackEvents.TRACK_STREAMING_STATUS_CHANGED).toBe(
            "track.streaming_status_changed",
        );
        expect(JitsiTrackEvents.TRACK_VIDEOTYPE_CHANGED).toBe(
            "track.videoTypeChanged",
        );
        expect(JitsiTrackEvents.NO_DATA_FROM_SOURCE).toBe(
            "track.no_data_from_source",
        );
