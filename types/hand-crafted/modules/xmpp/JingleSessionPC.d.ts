...
export default class JingleSessionPC extends JingleSession {
    ...
    acceptOffer: (
        jingleOffer: JQuery,
        success: (params: unknown) => unknown,
        failure: (params: unknown) => unknown,
    ...
    setOfferAnswerCycle: (
        jingleOfferAnswerIq: JQuery,
        success: (params: unknown) => unknown,
        failure: (params: unknown) => unknown,
        localTracks?: JitsiLocalTrack[],
    ) => void; // TODO:
    setVideoCodecs: (
        preferred?: CodecMimeType,
        disabled?: CodecMimeType,
    ) => void;
    ...
    ) => (this: JingleSessionPC) => unknown; // TODO:
