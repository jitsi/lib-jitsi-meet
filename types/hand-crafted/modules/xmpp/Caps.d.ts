...
export default class Caps extends Listenable {
    ...
    parseDiscoInfo: (node: string) => {
        features: Set<string>;
        identities: Set<{ type: string; name: string; category: string }>;
    }; // TODO: (string here is a jquery selector)
    ...
    getFeaturesAndIdentities: (
        ...
        node: string,
        timeout?: number,
    ) => Promise<Set<string> | Error>; // TODO: check the promise
}
