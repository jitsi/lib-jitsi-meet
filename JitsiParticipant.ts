...
export default class JitsiParticipant {
    ...
    private _statsID: string | undefined;
    private _properties: Map<string, any>;
    private _identity: object | undefined;
    private _isReplacing: boolean | undefined;
    private _isReplaced: boolean | undefined;
    private _isSilent: boolean | undefined;
    private _features: Set<string>;
    private _sources: Map<MediaType, Map<string, SourceInfo>>;
    private _botType: string | undefined;
    private _connectionJid: string | undefined;
     ...
     */
    getSources(): Map<MediaType, Map<string, SourceInfo>> {
