 ...
 * @returns {string} eg. endpointA-v0
 */
export function getSourceNameForJitsiTrack(endpointId: EndpointId, mediaType: MediaType, trackIdx: number): string {
 ...
 * @returns {MediaType}
 */
export function getMediaTypeFromSourceName(sourceName: string): MediaType {
 ...
 * {@link getSourceNameForJitsiTrack}).
 *
 * @param {string} sourceName - the source name, eg. endpointA-v0.
 * @returns {number}
 */
export function getSourceIndexFromSourceName(sourceName: string): number {
...
export default class SignalingLayer extends Listenable {
     ...
     */
    getPeerMediaInfo(
            owner: string, mediaType: MediaType, sourceName: string
     ...
     * @param {string} sourceName - The name of the source for which the info is to be obtained.
     * @returns {Optional<ITPCSourceInfo>}
     */
    getPeerSourceInfo(
            owner: EndpointId, sourceName: string
    ): Optional<ITPCSourceInfo> {
        throw new Error('not implemented');
    }
     ...
     * @returns {Optional<string>} the track's source name.
     */
    getTrackSourceName(ssrc: number): Optional<string> {
        throw new Error('not implemented');
    }
     ...
     *
     * @param {string} sourceName - the name of the track's source.
     * @param {boolean} muted - the new muted status.
     * @returns {boolean}
     */
    setTrackMuteStatus(sourceName: string, muted: boolean) {
    }
     ...
     * @returns {boolean}
     */
    setTrackVideoType(sourceName: string, videoType: VideoType) {
    }
