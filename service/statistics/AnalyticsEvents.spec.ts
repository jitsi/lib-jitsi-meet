...
describe("/service/statistics/AnalyticsEvents members", () => {
    ...
    it("known members", () => {
        ...
        expect(ICE_ESTABLISHMENT_DURATION_DIFF).toBe(
        ...
        expect(AnalyticsEvents.ACTION_JINGLE_SA_TIMEOUT).toBe(
            "session-accept.timeout",
        );
        expect(AnalyticsEvents.ACTION_JINGLE_SI_RECEIVED).toBe(
            "session-initiate.received",
        );
        expect(AnalyticsEvents.ACTION_JINGLE_SI_TIMEOUT).toBe(
        ...
        expect(AnalyticsEvents.CONNECTION_DISCONNECTED).toBe(
            "connection.disconnected",
        );
        expect(AnalyticsEvents.FEEDBACK).toBe("feedback");
        expect(AnalyticsEvents.ICE_DURATION).toBe("ice.duration");
        expect(AnalyticsEvents.ICE_ESTABLISHMENT_DURATION_DIFF).toBe(
            "ice.establishment.duration.diff",
        );
